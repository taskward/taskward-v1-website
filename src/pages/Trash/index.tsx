...
export default function Trash(): JSX.Element {
  ...
  const { data: notesData, isLoading: isGetTrashNotesLoading } = useGetTrashNotesRequest()
  ...
  useEffect(() => {
    sidebarDispatch(sidebarAction.changeActiveSidebarItem(ActiveSidebarItem.Trash))
  }, [])
