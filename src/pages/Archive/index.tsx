...
export default function Archive(): JSX.Element {
  ...
  const { data: notesData, isLoading: isGetArchiveNotesLoading } = useGetArchiveNotesRequest()
  ...
  useEffect(() => {
    sidebarDispatch(sidebarAction.changeActiveSidebarItem(ActiveSidebarItem.Archive))
  }, [])
