  ...
  return (
    ...
    >
      ...
      <div className="mt-2 flex flex-col text-sm">
        <span className="text-center">👏 {t('request:LOGIN.WELCOME.FIRST.LINE')}</span>
        <span className="text-center">🎉 {t('request:LOGIN.WELCOME.SECOND.LINE')}</span>
      </div>
      <Input
        className="mt-2"
      ...
      <GitHubButton
        className="mt-1"
        title={t('request:LOGIN.WITH.GITHUB')}
      />
      {state?.message && (
